namespace Carpet.Web.ViewModels.Administration.Orders.AllWaitingPickUpConfirmation
{
    ...
    public class OrderAllWaitingPickUpConfirmationViewModel : IMapFrom<Order>, IMapFrom<Customer>, IHaveCustomMappings
    {
        public string Id { get; set; }

        public string CustomerId { get; set; }

        public OrderCustomerAllWaitingPickUpConfirmationViewModel Customer { get; set; }
        ...
        {
            configuration
                .CreateMap<Order, OrderAllWaitingPickUpConfirmationViewModel>()
                .ForMember(
